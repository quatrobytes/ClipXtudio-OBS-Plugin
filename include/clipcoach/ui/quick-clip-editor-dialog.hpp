...
public:
	...
	QuickClipEditorDialog(TranslationFunction translator, ClipMetadata clip, ExportManager *exportManager,
	...
	void setCaption(const QString &socialCaption, const QString &youtubeShortsCaption = {});
